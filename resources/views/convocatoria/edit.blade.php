...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    ...
    <div class="container">
        <div class= "row">
            ...
            <form action= "{{ route('convocatoria.update', $convocatoria->id) }}" method="POST" enctype="multipart/form-data" >
                @method('PATCH')
                @csrf
                ...
                <h2 class="text-center p-2">Convocatoria</h2>
                    <div class="col-7" style="margin: 0 auto;"> 
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="titulo" value="{{$convocatoria->titulo}}" id="formGroupExampleInput" class="form-control-file">
                        </div>

                        <div class="mb-1">
                            <label for="formGroupExampleInput" class="form-label">Fecha</label>
                            <input class="form-control" type="date" name="fecha" value="{{$convocatoria->fecha}}"id="formGroupExampleInput" class="form-control-file">
                        </div>

                        <div class="mb-1">
                            <label for="formGroupExampleInput" class="form-label">Codigo</label>
                            <input class="form-control" type="text" name="codigo" value="{{$convocatoria->codigo}}" id="formGroupExampleInput" class="form-control-file">
                        </div>


                        <div class="mb-3">
                            <label for="inputPassword4"  class="form-label">Semestre</label>
                                <select class="form-select" name="semestre" value="{{$convocatoria->semestre}}" aria-label="Default select example">
                        ...
                        <div class="mb-3">
                            <label for="inputPassword4"  class="form-label">Subir PDF "Convocatoria"</label>
                            <input type="file" class="form-control" name="file" aria-label="file example" required>
                            <div class="invalid-feedback">Subir PDF "Convocatoria"</div>
                        </div>
