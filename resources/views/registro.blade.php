...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    ...
    <div class="container">
        <form>
            ...
            <div class="mb-3">
                <label for="inputPassword4" name="semestre" class="form-label">Semestre</label>
            ...
            <div class="mb-3">
                <label for="exampleFormControlFile1" >Pliego de Especificacion</label>
                <input class="form-control form-control-sm" id="formFileSm" type="file">
            </div>

            <div class="class="col-12 d-grid gap-2"">
                <button class="btn btn-success" col-12 type="submit">Aceptar</button>
