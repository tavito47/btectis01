                ...
                <h2 class="text-center p-2">Pliegos de especificaciones</h2>
                    <div class="col-7" style="margin: 0 auto;"> 
                        <div class="mb-1 ">
                            ...
                            <input class="form-control" type="text" name="docente" value="{{$pliego->docente}}" id="formGroupExampleInput" class="form-control-file">
                        </div>

                        <div class="mb-3">
                            <label for="formGroupExampleInput" class="form-label">Titulo</label>
                            <input class="form-control" type="text" name="titulo" value="{{$pliego->titulo}}" id="formGroupExampleInput" class="form-control-file">
                        </div>

                        <div class="mb-3">
                            <label for="formGroupExampleInput" class="form-label">Materia</label>
                            <input class="form-control" type="text" name="materia" value="{{$pliego->materia}}" id="formGroupExampleInput" class="form-control-file">
                        </div>

                        <div class="mb-1">
                            <label for="formGroupExampleInput" class="form-label">Fecha</label>
                            <input class="form-control" type="date" name="fecha" value="{{$pliego->fecha}}"id="formGroupExampleInput" class="form-control-file">
                        </div>

                        <div class="mb-1">
                            <label for="formGroupExampleInput" class="form-label">SisMat</label>
                            <input class="form-control" type="text" name="sismat" value="{{$pliego->sismat}}" id="formGroupExampleInput" class="form-control-file">
                        </div>


                        <div class="mb-3">
                            <label for="inputPassword4"  class="form-label">Semestre</label>
                                <select class="form-select" name="semestre" value="{{$pliego->semestre}}" aria-label="Default select example">
